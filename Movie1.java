...
class Movie1 extends JFrame implements ActionListener
{
    ...
    {   
        ...
        try
        {
          ...
          Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/movie","root","guppy");
          Statement stm=con.createStatement();
          String qry="select * from movies ";
          ResultSet rs=stm.executeQuery(qry);
          System.out.println("Vijay KV 68");
          while(rs.next())
          {
            if(source==book)
                 {
            ...
            if(source==no)
                 {
                   ...
                   n2.setText("Select Seats_Available from movies where Movie_Name='"+s1+"'");
                 }
          }
          if(numrows>0)
          {
